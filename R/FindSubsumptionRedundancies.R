...
#' FindSubsumptionRedundancies
#'
#' Auxiliary function within \code{\link{SubsumeRecords}}
#'
...
#'
#' @return The input Table with records being marked as redundant by subsumption
#'
#' @export
#'
#' @author Bastian Reiter
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
FindSubsumptionRedundancies <- function(Table,
                                        PrimaryKey,
                                        DistinctiveFeatures,
