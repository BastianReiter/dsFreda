...
# For consistency reasons, set up 'DataSet' as object that holds all data throughout the function
DataSet <- RawDataSet
                ...
                imap(function(Table, tablename)
                     {
                        ...
                        EligibleFeatureNames <- filter(dsCCPhos::Meta_Features, TableName_Curated == tablename)$FeatureName_Raw
